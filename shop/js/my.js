...
(function ($) {
    $(function () {
        let $showMoreBtn = $("#showMore");

        $($showMoreBtn).on('click', () => {
            let data_count_show = $($showMoreBtn).data('count-show');
            let data_count_add = $($showMoreBtn).data('count-add');

            ajax(data_count_show,
                data_count_add);

        });

        function ajax(data_count_show,
                      data_count_add) {
            $.ajax({
                ...
                data: {
                    "method": showMore,
                    "count_show": data_count_show,
                    "count_add": data_count_add,
